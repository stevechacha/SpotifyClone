...
class TabBarViewController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        let homeController = ChaptersViewController()
        let searchController = SearchArtistViewController()
        let libraryController = ChaptersViewController()
        ...
        let nav4 = UINavigationController(rootViewController: artistController)
        let nav5 = UINavigationController(rootViewController: albumController)
        ...
        nav3.tabBarItem = UITabBarItem(title: "Artist", image: UIImage(systemName: "music.note.list"), tag: 4)
        nav3.tabBarItem = UITabBarItem(title: "Album", image: UIImage(systemName: "music.note.list"), tag: 5)
